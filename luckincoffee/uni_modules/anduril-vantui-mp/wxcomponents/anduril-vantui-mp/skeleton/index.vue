<template>
<uni-shadow-root class="anduril-vantui-mp-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = 'anduril-vantui-mp/skeleton/index'
...
export default global['__wxComponents']['anduril-vantui-mp/skeleton/index']
</script>
