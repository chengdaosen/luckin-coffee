<template>
<uni-shadow-root class="anduril-vantui-mp-tabs-index"><view :class="'custom-class '+(utils.bem('tabs', [type]))">
...
global['__wxRoute'] = 'anduril-vantui-mp/tabs/index'
...
export default global['__wxComponents']['anduril-vantui-mp/tabs/index']
</script>
