<template>
<uni-shadow-root class="anduril-vantui-mp-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'anduril-vantui-mp/share-sheet/options'
...
export default global['__wxComponents']['anduril-vantui-mp/share-sheet/options']
</script>
