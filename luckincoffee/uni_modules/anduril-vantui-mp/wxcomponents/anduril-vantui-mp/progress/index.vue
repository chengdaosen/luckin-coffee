<template>
<uni-shadow-root class="anduril-vantui-mp-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = 'anduril-vantui-mp/progress/index'
...
export default global['__wxComponents']['anduril-vantui-mp/progress/index']
</script>
