<template>
<uni-shadow-root class="anduril-vantui-mp-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll"></van-overlay>
...
global['__wxRoute'] = 'anduril-vantui-mp/popup/index'
...
export default global['__wxComponents']['anduril-vantui-mp/popup/index']
</script>
