<template>
<uni-shadow-root class="anduril-vantui-mp-dropdown-item-index"><view v-if="showWrapper" :class="utils.bem('dropdown-item', direction)" :style="wrapperStyle">
...
global['__wxRoute'] = 'anduril-vantui-mp/dropdown-item/index'
...
export default global['__wxComponents']['anduril-vantui-mp/dropdown-item/index']
</script>
