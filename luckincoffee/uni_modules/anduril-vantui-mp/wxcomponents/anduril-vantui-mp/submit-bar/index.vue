<template>
<uni-shadow-root class="anduril-vantui-mp-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/submit-bar/index'
...
export default global['__wxComponents']['anduril-vantui-mp/submit-bar/index']
</script>
