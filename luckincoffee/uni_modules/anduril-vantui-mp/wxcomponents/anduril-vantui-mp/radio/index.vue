<template>
<uni-shadow-root class="anduril-vantui-mp-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = 'anduril-vantui-mp/radio/index'
...
export default global['__wxComponents']['anduril-vantui-mp/radio/index']
</script>
