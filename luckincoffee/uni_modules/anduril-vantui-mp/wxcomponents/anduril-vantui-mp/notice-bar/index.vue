<template>
<uni-shadow-root class="anduril-vantui-mp-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/notice-bar/index'
...
export default global['__wxComponents']['anduril-vantui-mp/notice-bar/index']
</script>
