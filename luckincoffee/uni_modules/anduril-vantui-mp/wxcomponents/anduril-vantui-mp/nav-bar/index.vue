<template>
<uni-shadow-root class="anduril-vantui-mp-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = 'anduril-vantui-mp/nav-bar/index'
...
export default global['__wxComponents']['anduril-vantui-mp/nav-bar/index']
</script>
