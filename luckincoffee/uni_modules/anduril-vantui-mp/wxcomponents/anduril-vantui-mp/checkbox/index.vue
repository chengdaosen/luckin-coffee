<template>
<uni-shadow-root class="anduril-vantui-mp-checkbox-index"><view :class="(utils.bem('checkbox', [{ horizontal: direction === 'horizontal' }]))+' custom-class'">
...
global['__wxRoute'] = 'anduril-vantui-mp/checkbox/index'
...
export default global['__wxComponents']['anduril-vantui-mp/checkbox/index']
</script>
