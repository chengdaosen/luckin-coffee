<template>
<uni-shadow-root class="anduril-vantui-mp-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/image/index'
...
export default global['__wxComponents']['anduril-vantui-mp/image/index']
</script>
