<template>
<uni-shadow-root class="anduril-vantui-mp-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = 'anduril-vantui-mp/empty/index'
...
export default global['__wxComponents']['anduril-vantui-mp/empty/index']
</script>
