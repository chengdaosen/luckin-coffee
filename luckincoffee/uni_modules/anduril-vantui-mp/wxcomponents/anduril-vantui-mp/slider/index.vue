<template>
<uni-shadow-root class="anduril-vantui-mp-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled }))" :style="style({ background: inactiveColor, height: utils.addUnit(barHeight) })" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/slider/index'
...
export default global['__wxComponents']['anduril-vantui-mp/slider/index']
</script>
