<template>
<uni-shadow-root class="anduril-vantui-mp-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'anduril-vantui-mp/search/index'
...
export default global['__wxComponents']['anduril-vantui-mp/search/index']
</script>
