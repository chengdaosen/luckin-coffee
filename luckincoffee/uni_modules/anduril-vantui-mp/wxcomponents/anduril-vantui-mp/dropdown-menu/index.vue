<template>
<uni-shadow-root class="anduril-vantui-mp-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom">
...
global['__wxRoute'] = 'anduril-vantui-mp/dropdown-menu/index'
...
export default global['__wxComponents']['anduril-vantui-mp/dropdown-menu/index']
</script>
