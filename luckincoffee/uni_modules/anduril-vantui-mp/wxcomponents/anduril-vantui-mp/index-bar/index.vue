<template>
<uni-shadow-root class="anduril-vantui-mp-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/index-bar/index'
...
export default global['__wxComponents']['anduril-vantui-mp/index-bar/index']
</script>
