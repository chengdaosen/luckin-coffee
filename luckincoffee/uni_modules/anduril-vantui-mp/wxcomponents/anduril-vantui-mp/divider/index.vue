<template>
<uni-shadow-root class="anduril-vantui-mp-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/divider/index'
...
export default global['__wxComponents']['anduril-vantui-mp/divider/index']
</script>
