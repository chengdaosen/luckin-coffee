<template>
<uni-shadow-root class="anduril-vantui-mp-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = 'anduril-vantui-mp/uploader/index'
...
export default global['__wxComponents']['anduril-vantui-mp/uploader/index']
</script>
