<template>
<uni-shadow-root class="anduril-vantui-mp-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'anduril-vantui-mp/collapse-item/index'
...
export default global['__wxComponents']['anduril-vantui-mp/collapse-item/index']
</script>
