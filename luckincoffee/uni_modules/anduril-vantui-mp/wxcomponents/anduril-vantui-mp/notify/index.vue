<template>
<uni-shadow-root class="anduril-vantui-mp-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = 'anduril-vantui-mp/notify/index'
...
export default global['__wxComponents']['anduril-vantui-mp/notify/index']
</script>
