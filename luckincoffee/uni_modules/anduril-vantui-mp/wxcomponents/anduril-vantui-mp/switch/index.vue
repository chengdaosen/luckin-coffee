<template>
<uni-shadow-root class="anduril-vantui-mp-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor })" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/switch/index'
...
export default global['__wxComponents']['anduril-vantui-mp/switch/index']
</script>
