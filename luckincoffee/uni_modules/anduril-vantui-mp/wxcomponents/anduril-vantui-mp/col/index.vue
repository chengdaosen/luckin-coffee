<template>
<uni-shadow-root class="anduril-vantui-mp-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/col/index'
...
export default global['__wxComponents']['anduril-vantui-mp/col/index']
</script>
