<template>
<uni-shadow-root class="anduril-vantui-mp-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'anduril-vantui-mp/rate/index'
...
export default global['__wxComponents']['anduril-vantui-mp/rate/index']
</script>
