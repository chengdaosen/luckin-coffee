<template>
<uni-shadow-root class="anduril-vantui-mp-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/grid-item/index'
...
export default global['__wxComponents']['anduril-vantui-mp/grid-item/index']
</script>
