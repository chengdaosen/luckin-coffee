<template>
<uni-shadow-root class="anduril-vantui-mp-loading-index"><view :class="'custom-class '+(utils.bem('loading', { vertical }))">
...
global['__wxRoute'] = 'anduril-vantui-mp/loading/index'
