<template>
<uni-shadow-root class="anduril-vantui-mp-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = 'anduril-vantui-mp/card/index'
...
export default global['__wxComponents']['anduril-vantui-mp/card/index']
</script>
