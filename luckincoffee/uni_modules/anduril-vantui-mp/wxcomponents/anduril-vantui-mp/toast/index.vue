<template>
<uni-shadow-root class="anduril-vantui-mp-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :z-index="zIndex" :custom-style="mask ? '' : 'background-color: transparent;'"></van-overlay>
...
global['__wxRoute'] = 'anduril-vantui-mp/toast/index'
...
export default global['__wxComponents']['anduril-vantui-mp/toast/index']
</script>
