<template>
<uni-shadow-root class="anduril-vantui-mp-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'anduril-vantui-mp/steps/index'
...
export default global['__wxComponents']['anduril-vantui-mp/steps/index']
</script>
