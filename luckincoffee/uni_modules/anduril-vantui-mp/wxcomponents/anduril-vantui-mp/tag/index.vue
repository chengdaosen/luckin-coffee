<template>
<uni-shadow-root class="anduril-vantui-mp-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/tag/index'
...
export default global['__wxComponents']['anduril-vantui-mp/tag/index']
</script>
