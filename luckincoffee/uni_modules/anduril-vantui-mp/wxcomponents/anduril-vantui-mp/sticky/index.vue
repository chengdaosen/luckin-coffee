<template>
<uni-shadow-root class="anduril-vantui-mp-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'anduril-vantui-mp/sticky/index'
...
export default global['__wxComponents']['anduril-vantui-mp/sticky/index']
</script>
