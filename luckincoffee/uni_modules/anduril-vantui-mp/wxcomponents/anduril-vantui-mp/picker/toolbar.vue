<template>
<uni-shadow-root class="anduril-vantui-mp-picker-toolbar"><view v-if="showToolbar" class="van-picker__toolbar toolbar-class">
...
global['__wxRoute'] = 'anduril-vantui-mp/picker/toolbar'

Component({})

export default global['__wxComponents']['anduril-vantui-mp/picker/toolbar']
</script>
