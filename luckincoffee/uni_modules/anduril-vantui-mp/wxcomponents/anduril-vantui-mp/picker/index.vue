<template>
<uni-shadow-root class="anduril-vantui-mp-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = 'anduril-vantui-mp/picker/index'
...
export default global['__wxComponents']['anduril-vantui-mp/picker/index']
</script>
