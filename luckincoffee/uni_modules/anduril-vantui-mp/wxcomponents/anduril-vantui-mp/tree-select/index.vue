<template>
<uni-shadow-root class="anduril-vantui-mp-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
...
global['__wxRoute'] = 'anduril-vantui-mp/tree-select/index'
...
export default global['__wxComponents']['anduril-vantui-mp/tree-select/index']
</script>
