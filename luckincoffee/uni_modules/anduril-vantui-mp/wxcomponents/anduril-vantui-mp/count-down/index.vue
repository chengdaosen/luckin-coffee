<template>
<uni-shadow-root class="anduril-vantui-mp-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'anduril-vantui-mp/count-down/index'
...
export default global['__wxComponents']['anduril-vantui-mp/count-down/index']
</script>
