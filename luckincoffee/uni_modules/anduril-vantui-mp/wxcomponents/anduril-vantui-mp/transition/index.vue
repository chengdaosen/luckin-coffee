<template>
<uni-shadow-root class="anduril-vantui-mp-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'anduril-vantui-mp/transition/index'
...
export default global['__wxComponents']['anduril-vantui-mp/transition/index']
</script>
