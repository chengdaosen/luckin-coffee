<template>
<uni-shadow-root class="anduril-vantui-mp-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'anduril-vantui-mp/calendar/components/header/index'
...
export default global['__wxComponents']['anduril-vantui-mp/calendar/components/header/index']
</script>
