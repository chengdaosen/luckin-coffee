<template>
<uni-shadow-root class="anduril-vantui-mp-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = 'anduril-vantui-mp/calendar/components/month/index'
...
export default global['__wxComponents']['anduril-vantui-mp/calendar/components/month/index']
</script>
