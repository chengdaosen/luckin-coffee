<template>
<uni-shadow-root class="anduril-vantui-mp-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'anduril-vantui-mp/calendar/calendar'

Component({})

export default global['__wxComponents']['anduril-vantui-mp/calendar/calendar']
</script>
