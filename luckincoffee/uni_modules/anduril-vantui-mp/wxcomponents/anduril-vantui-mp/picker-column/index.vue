<template>
<uni-shadow-root class="anduril-vantui-mp-picker-column-index"><view class="van-picker-column custom-class" :style="computed.rootStyle({ itemHeight, visibleItemCount })" @touchstart="onTouchStart" @touchmove.stop.prevent="onTouchMove" @touchend="onTouchEnd" @touchcancel="onTouchEnd">
...
global['__wxRoute'] = 'anduril-vantui-mp/picker-column/index'
...
export default global['__wxComponents']['anduril-vantui-mp/picker-column/index']
</script>
