<template>
<uni-shadow-root class="anduril-vantui-mp-cell-index"><view :class="'custom-class '+(utils.bem('cell', [size, { center, required, borderless: !border, clickable: isLink || clickable }]))" hover-class="van-cell--hover hover-class" hover-stay-time="70" :style="customStyle" @click="onClick">
...
global['__wxRoute'] = 'anduril-vantui-mp/cell/index'
...
export default global['__wxComponents']['anduril-vantui-mp/cell/index']
</script>
