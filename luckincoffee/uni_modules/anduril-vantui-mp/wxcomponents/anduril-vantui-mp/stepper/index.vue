<template>
<uni-shadow-root class="anduril-vantui-mp-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'anduril-vantui-mp/stepper/index'
...
export default global['__wxComponents']['anduril-vantui-mp/stepper/index']
</script>
