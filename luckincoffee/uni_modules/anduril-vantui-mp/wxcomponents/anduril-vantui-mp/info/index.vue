<template>
<uni-shadow-root class="anduril-vantui-mp-info-index"><view v-if="info !== null && info !== '' || dot" :class="'van-info '+(utils.bem('info', { dot }))+' custom-class'" :style="customStyle">{{ dot ? '' : info }}</view></uni-shadow-root>
</template>
<wxs src="../wxs/utils.wxs" module="utils"></wxs>
<script>

global['__wxRoute'] = 'anduril-vantui-mp/info/index'
...
export default global['__wxComponents']['anduril-vantui-mp/info/index']
</script>
